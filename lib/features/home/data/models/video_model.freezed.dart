...
class _$_VideoModel implements _VideoModel {
  ...
  @override
  String toString() {
    return 'VideoModel(contentId: $contentId, caption: $caption, thumbnail: $thumbnail, url: $url, views: $views, likes: $likes, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, contentId, caption, thumbnail, url, views, likes, createdAt);
...
abstract class _VideoModel implements VideoModel {
  const factory _VideoModel(
      ...
      final num? views,
      final num? likes,
      final DateTime? createdAt}) = _$_VideoModel;
